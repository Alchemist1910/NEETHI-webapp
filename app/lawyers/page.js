            ...
            <div className="p-10 max-w-7xl mx-auto">
                ...
                {loading ? (
                    ...
                    <p className="text-gray-400">
                        No lawyers found in the system yet.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        ...
                        {lawyers.map((lawyer) => {
                            ...
                            const avatarURL =
                                `https://api.dicebear.com/7.x/avataaars/svg?seed=${lawyer.name || lawyer.uid}&gender=${lawyer.gender || "male"}&backgroundColor=transparent`;

                            return (

                                <div
                                    key={lawyer.id}
                                    className="bg-[#222] rounded-3xl overflow-hidden shadow-lg border border-white/5 flex flex-col"
                                >
